###########################################################################
## Makefile generated for component 'DCmotor_OL_Ctrl'. 
## 
## Makefile     : DCmotor_OL_Ctrl.mk
## Generated on : Mon Oct 14 14:45:13 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DCmotor_OL_Ctrl.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DCmotor_OL_Ctrl.elf
...
DEFINES_STANDARD = -DMODEL=DCmotor_OL_Ctrl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
DCmotor_OL_Ctrl.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/DCmotor_OL_Ctrl.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


DCmotor_OL_Ctrl_data.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/DCmotor_OL_Ctrl_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetInf.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetNaN.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rt_nonfinite.o : $(START_DIR)/DCmotor_OL_Ctrl_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
