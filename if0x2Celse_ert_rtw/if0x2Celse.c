...
void if0x2Celse_step(void)
{
  ...
  /* Step: '<Root>/Step3' */
  if (tmp < if0x2Celse_P.Step3_Time) {
    /* Step: '<Root>/Step3' */
    if0x2Celse_B.Step3 = if0x2Celse_P.Step3_Y0;
  } else {
    /* Step: '<Root>/Step3' */
    if0x2Celse_B.Step3 = if0x2Celse_P.Step3_YFinal;
  }

  /* Delay: '<Root>/Delay' */
  if0x2Celse_B.Delay = if0x2Celse_DW.Delay_DSTATE[0];

  /* Update for Delay: '<Root>/Delay' */
  if0x2Celse_DW.Delay_DSTATE[0] = if0x2Celse_DW.Delay_DSTATE[1];
  if0x2Celse_DW.Delay_DSTATE[1] = if0x2Celse_B.Step3;
...
void if0x2Celse_initialize(void)
{
  ...
  /* External mode info */
  if0x2Celse_M->Sizes.checksums[0] = (2680057700U);
  if0x2Celse_M->Sizes.checksums[1] = (3291193626U);
  if0x2Celse_M->Sizes.checksums[2] = (2550646299U);
  if0x2Celse_M->Sizes.checksums[3] = (54512170U);
  ...
  if0x2Celse_DW.Delay_DSTATE[0] = if0x2Celse_P.Delay_InitialCondition;
  if0x2Celse_DW.Delay_DSTATE[1] = if0x2Celse_P.Delay_InitialCondition;
}
