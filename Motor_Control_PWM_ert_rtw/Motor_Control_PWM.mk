###########################################################################
## Makefile generated for component 'Motor_Control_PWM'. 
## 
## Makefile     : Motor_Control_PWM.mk
## Generated on : Mon Oct 14 13:36:45 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Motor_Control_PWM.elf
...
PRODUCT_NAME              = Motor_Control_PWM
MAKEFILE                  = Motor_Control_PWM.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Motor_Control_PWM.elf
...
DEFINES_STANDARD = -DMODEL=Motor_Control_PWM -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o Motor_Control_PWM.o Motor_Control_PWM_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
Motor_Control_PWM.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/Motor_Control_PWM.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


Motor_Control_PWM_data.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/Motor_Control_PWM_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetInf.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetNaN.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rt_nonfinite.o : $(START_DIR)/Motor_Control_PWM_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
