...
void HC_SR04_ultrasonic_initialize(void)
{
  ...
  /* External mode info */
  HC_SR04_ultrasonic_M->Sizes.checksums[0] = (3936664593U);
  HC_SR04_ultrasonic_M->Sizes.checksums[1] = (2124640511U);
  HC_SR04_ultrasonic_M->Sizes.checksums[2] = (1344691270U);
  HC_SR04_ultrasonic_M->Sizes.checksums[3] = (1735296653U);
