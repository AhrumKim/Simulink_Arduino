 ...
 * C/C++ source code generated on : Mon Oct 14 14:46:59 2024
 *
...
int main(void)
{
  ...
  errorCode = extmodeInit(Motor_Control_M->extModeInfo, &rtmGetTFinal
    (Motor_Control_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(Motor_Control_M, true);
    }
  }
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(Motor_Control_M);
