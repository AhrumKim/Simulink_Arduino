 ...
 * C/C++ source code generated on : Tue Oct 15 13:51:06 2024
 *
...
void DCmotor_Speed_Ctrl_step(void)
{
...

  {
    ...
    /* MATLABSystem: '<S1>/PWM' */
    DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
      (11UL);
     ...
     */
    MW_PWM_SetDutyCycle(DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE,
...
void DCmotor_Speed_Ctrl_initialize(void)
{
  ...
  rtmSetTFinal(DCmotor_Speed_Ctrl_M, 20.0);
  ...
  DCmotor_Speed_Ctrl_DW.obj_n.matlabCodegenIsDeleted = false;
  DCmotor_Speed_Ctrl_DW.obj_n.isInitialized = 1L;
  DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(11UL, 0.0,
    0.0);
  DCmotor_Speed_Ctrl_DW.obj_n.isSetupComplete = true;
...
void DCmotor_Speed_Ctrl_terminate(void)
{
  ...
  if (!DCmotor_Speed_Ctrl_DW.obj_n.matlabCodegenIsDeleted) {
    DCmotor_Speed_Ctrl_DW.obj_n.matlabCodegenIsDeleted = true;
    if ((DCmotor_Speed_Ctrl_DW.obj_n.isInitialized == 1L) &&
        DCmotor_Speed_Ctrl_DW.obj_n.isSetupComplete) {
      DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
        (11UL);
      MW_PWM_SetDutyCycle(DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE,
                          0.0);
      DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
        (11UL);
      MW_PWM_Close(DCmotor_Speed_Ctrl_DW.obj_n.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
