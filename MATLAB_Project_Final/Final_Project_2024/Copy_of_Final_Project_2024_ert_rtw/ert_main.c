...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T)
    Copy_of_Final_Project_2024_M->Timing.clockTick0;
  Copy_of_Final_Project_2024_step();
...
int main(void)
{
  ...
  init();
  MW_Arduino_Init();
  rtmSetErrorStatus(Copy_of_Final_Project_2024_M, 0);
  ...
  Copy_of_Final_Project_2024_initialize();
  cli();
  sei();

  /* External Mode initialization */
  errorCode = extmodeInit(Copy_of_Final_Project_2024_M->extModeInfo,
    &rtmGetTFinal(Copy_of_Final_Project_2024_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(Copy_of_Final_Project_2024_M, true);
    }
  }
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(Copy_of_Final_Project_2024_M);
  ...
  /* Terminate model */
  Copy_of_Final_Project_2024_terminate();
