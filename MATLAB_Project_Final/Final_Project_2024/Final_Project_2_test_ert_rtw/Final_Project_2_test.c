...
void Final_Project_2_test_step(void)
{
  ...
  /* Reset subsysRan breadcrumbs */
  srClearBC(Final_Project_2_test_DW.IfActionSubsystem1_SubsysRanB_g);

  /* Reset subsysRan breadcrumbs */
  srClearBC(Final_Project_2_test_DW.IfActionSubsystem_SubsysRanBC_f);

  /* Reset subsysRan breadcrumbs */
  srClearBC(Final_Project_2_test_DW.IfActionSubsystem2_SubsysRanB_h);
  ...
  /* Reset subsysRan breadcrumbs */
  srClearBC(Final_Project_2_test_DW.IfActionSubsystem2_SubsysRanB_l);
  ...
  if (Final_Project_2_test_B.Merge3 == 0.0) {
    ...
    /* Update for IfAction SubSystem: '<S2>/ACC OFF' incorporates:
     *  ActionPort: '<S3>/Action Port'
     */
    /* Update for If: '<S2>/If' */
    srUpdateBC(Final_Project_2_test_DW.ACCOFF_SubsysRanBC);

    /* End of Update for SubSystem: '<S2>/ACC OFF' */
    ...
    if (rtb_UltrasonicSensor < 0.1) {
       ...
       */
      /* Update for If: '<S4>/If' */
      srUpdateBC(Final_Project_2_test_DW.IfActionSubsystem1_SubsysRanB_g);
       ...
       */
      /* Update for If: '<S4>/If' */
      srUpdateBC(Final_Project_2_test_DW.IfActionSubsystem_SubsysRanBC_f);
      ...
      /* Merge: '<S2>/Merge' incorporates:
       *  SignalConversion generated from: '<S12>/PWM_in'
       */
       ...
       */
      /* Update for If: '<S4>/If' */
      srUpdateBC(Final_Project_2_test_DW.IfActionSubsystem2_SubsysRanB_h);
    ...
    /* Update for IfAction SubSystem: '<S2>/ACC Standby   ' incorporates:
     *  ActionPort: '<S4>/Action Port'
     */
    /* Update for If: '<S2>/If' */
    srUpdateBC(Final_Project_2_test_DW.ACCStandby_SubsysRanBC);

    /* End of Update for SubSystem: '<S2>/ACC Standby   ' */
     ...
     *  SignalConversion generated from: '<S9>/Red_LED'
     */
    ...
    if (rtb_UltrasonicSensor < 0.1) {
       ...
       *  SignalConversion generated from: '<S16>/1'
       */
      Final_Project_2_test_B.Merge2 = Final_Project_2_test_P.Constant1_Value;

      /* Merge: '<S2>/Merge' incorporates:
       *  Constant: '<S16>/Constant'
       *  SignalConversion generated from: '<S16>/PWM_stop1'
       */
      ...
      /* Update for IfAction SubSystem: '<S9>/If Action Subsystem1' incorporates:
       *  ActionPort: '<S16>/Action Port'
       */
      /* Update for If: '<S9>/If' */
      srUpdateBC(Final_Project_2_test_DW.IfActionSubsystem1_SubsysRanB_m);

      /* End of Update for SubSystem: '<S9>/If Action Subsystem1' */
    } else if (rtb_UltrasonicSensor < 0.5) {
      ...
      /* Update for IfAction SubSystem: '<S9>/If Action Subsystem' incorporates:
       *  ActionPort: '<S15>/Action Port'
       */
      /* Update for If: '<S9>/If' */
      srUpdateBC(Final_Project_2_test_DW.IfActionSubsystem_SubsysRanBC_b);

      /* End of Update for SubSystem: '<S9>/If Action Subsystem' */
    } else {
       ...
       *  SignalConversion generated from: '<S17>/LED_OFF'
       */
      Final_Project_2_test_B.Merge2 = Final_Project_2_test_P.Constant_Value_j;

      /* Merge: '<S2>/Merge' incorporates:
       *  SignalConversion generated from: '<S17>/Input'
       */
      Final_Project_2_test_B.Merge = Final_Project_2_test_B.DataTypeConversion;

      /* End of Outputs for SubSystem: '<S9>/If Action Subsystem2' */

      /* Update for IfAction SubSystem: '<S9>/If Action Subsystem2' incorporates:
       *  ActionPort: '<S17>/Action Port'
       */
      /* Update for If: '<S9>/If' */
      srUpdateBC(Final_Project_2_test_DW.IfActionSubsystem2_SubsysRanB_l);

      /* End of Update for SubSystem: '<S9>/If Action Subsystem2' */
    }
   ...
   */
  rtb_UltrasonicSensor = rt_roundd_snf(Final_Project_2_test_P.Constant_Value_n);
  if (rtb_UltrasonicSensor < 256.0) {
    if (rtb_UltrasonicSensor >= 0.0) {
      tmp = (uint8_T)rtb_UltrasonicSensor;
    } else {
...
void Final_Project_2_test_initialize(void)
{
  ...
  /* External mode info */
  Final_Project_2_test_M->Sizes.checksums[0] = (1157043411U);
  Final_Project_2_test_M->Sizes.checksums[1] = (3007060940U);
  Final_Project_2_test_M->Sizes.checksums[2] = (1372506644U);
  Final_Project_2_test_M->Sizes.checksums[3] = (3643709938U);

  {
    ...
    systemRan[5] = (sysRanDType *)&Final_Project_2_test_DW.ACCOFF_SubsysRanBC;
    systemRan[6] = (sysRanDType *)
      &Final_Project_2_test_DW.IfActionSubsystem_SubsysRanBC_f;
    systemRan[7] = (sysRanDType *)
      &Final_Project_2_test_DW.IfActionSubsystem1_SubsysRanB_g;
    systemRan[8] = (sysRanDType *)
      &Final_Project_2_test_DW.IfActionSubsystem2_SubsysRanB_h;
    ...
    systemRan[19] = (sysRanDType *)
      &Final_Project_2_test_DW.IfActionSubsystem2_SubsysRanB_l;
  ...
  /* InitializeConditions for Sum: '<S5>/Sum' incorporates:
   *  UnitDelay: '<S5>/Unit Delay'
   */
  Final_Project_2_test_DW.UnitDelay_DSTATE_d =
