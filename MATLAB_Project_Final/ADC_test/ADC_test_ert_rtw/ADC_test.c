...
void ADC_test_step(void)
{
  ...
  if (ADC_test_DW.obj_i.SampleTime != ADC_test_P.AnalogInput_SampleTime) {
    ADC_test_DW.obj_i.SampleTime = ADC_test_P.AnalogInput_SampleTime;
  }

  ADC_test_DW.obj_i.AnalogInDriverObj.MW_ANALOGIN_HANDLE = MW_AnalogIn_GetHandle
    (54UL);
  MW_AnalogInSingle_ReadResult
    (ADC_test_DW.obj_i.AnalogInDriverObj.MW_ANALOGIN_HANDLE, &b_varargout_1,
     MW_ANALOGIN_UINT16);
...
void ADC_test_initialize(void)
{
  ...
  /* External mode info */
  ADC_test_M->Sizes.checksums[0] = (1282197580U);
  ADC_test_M->Sizes.checksums[1] = (2903656074U);
  ADC_test_M->Sizes.checksums[2] = (1077241042U);
  ADC_test_M->Sizes.checksums[3] = (3345921930U);
  ...
  ADC_test_DW.obj_i.matlabCodegenIsDeleted = false;
  ADC_test_DW.obj_i.SampleTime = ADC_test_P.AnalogInput_SampleTime;
  ADC_test_DW.obj_i.isInitialized = 1L;
  ADC_test_DW.obj_i.AnalogInDriverObj.MW_ANALOGIN_HANDLE =
    MW_AnalogInSingle_Open(54UL);
  ADC_test_DW.obj_i.isSetupComplete = true;
...
void ADC_test_terminate(void)
{
  ...
  if (!ADC_test_DW.obj_i.matlabCodegenIsDeleted) {
    ADC_test_DW.obj_i.matlabCodegenIsDeleted = true;
    if ((ADC_test_DW.obj_i.isInitialized == 1L) &&
        ADC_test_DW.obj_i.isSetupComplete) {
      ADC_test_DW.obj_i.AnalogInDriverObj.MW_ANALOGIN_HANDLE =
        MW_AnalogIn_GetHandle(54UL);
      MW_AnalogIn_Close(ADC_test_DW.obj_i.AnalogInDriverObj.MW_ANALOGIN_HANDLE);
    }
  }
