 ...
 * C/C++ source code generated on : Mon Oct 14 15:04:54 2024
 *
...
typedef struct {
  ...
  uint8_T is_active_c2_DCmotor_OL_Ctrl;/* '<S1>/MATLAB Function' */
 ...
 * '<S2>'   : 'DCmotor_OL_Ctrl/Function-Call Subsystem/MATLAB Function'
 */
