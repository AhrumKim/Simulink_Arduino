...
#ifndef RTW_HEADER_interrupt_h_
#define RTW_HEADER_interrupt_h_
#ifndef interrupt_COMMON_INCLUDES_
#define interrupt_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* interrupt_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  boolean_T TmpRTBAtFunctionCallSubsystemIn;/* '<Root>/NOT' */
  boolean_T In1;                       /* '<S1>/In1' */
} B_interrupt_T;
...
extern P_interrupt_T interrupt_P;

/* Block signals (default storage) */
extern B_interrupt_T interrupt_B;

/* Block states (default storage) */
extern DW_interrupt_T interrupt_DW;

/* Model entry point functions */
extern void interrupt_initialize(void);
extern void interrupt_step(void);
extern void interrupt_terminate(void);

/* Real-time Model object */
extern RT_MODEL_interrupt_T *const interrupt_M;
 ...
 *
 * Block '<Root>/If' : Unused code path elimination
 */
 ...
 *
 * '<Root>' : 'interrupt'
 * '<S1>'   : 'interrupt/Function-Call Subsystem'
 */
#endif                                 /* RTW_HEADER_interrupt_h_ */
